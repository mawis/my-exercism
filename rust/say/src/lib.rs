...
fn digit_pair(g: u64) -> String {
    match g {
        ...
        16...19 => unit(g - 10)+"teen",
        20...29 => regular_tenner("twenty", g % 10),
        30...39 => regular_tenner("thirty", g % 10),
        40...49 => regular_tenner("forty", g % 10),
        50...59 => regular_tenner("fifty", g % 10),
        60...69 => regular_tenner("sixty", g % 10),
        70...79 => regular_tenner("seventy", g % 10),
        80...89 => regular_tenner("eighty", g % 10),
        90...99 => regular_tenner("ninety", g % 10),
        _ => String::new()
    }
}
